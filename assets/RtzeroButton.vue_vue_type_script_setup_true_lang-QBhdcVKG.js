var M=Object.defineProperty;var A=(t,x,e)=>x in t?M(t,x,{enumerable:!0,configurable:!0,writable:!0,value:e}):t[x]=e;var a=(t,x,e)=>(A(t,typeof x!="symbol"?x+"":x,e),e);import{r as b,d as q,b as R,f as u,o as p,c as L,e as I,w as S,g as w,h as P,i as D,a as g}from"./index-BIzKhvK7.js";class T{constructor(x){a(this,"port");a(this,"end");this.port=x,this.end=async()=>{}}static async begin(x,e=!1){var n;const f=new T(x);await f.enterRawRepl(e);try{await f.exec("import sys,os")}catch(s){throw await((n=f.end)==null?void 0:n.call(f)),s}return f}async interruptProgram(x=2e4){const e=Date.now()+x;for(;x<=0||Date.now()<e;){await this.port.write("");try{let f=await this.port.readUntil(">>> ",500);this.port.prevRecvCbk&&f!==`\r
